...
public class GroupCreateActivity$ViewHolder_ViewBinding implements Unbinder {
  private GroupCreateActivity.ViewHolder target;

  private View view7f090059;

  @UiThread
  public GroupCreateActivity$ViewHolder_ViewBinding(final GroupCreateActivity.ViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    GroupCreateActivity.ViewHolder target = this.target;
