...
public class AdapterLibraryBindingImpl extends AdapterLibraryBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.info == variableId) {
            setInfo((com.kunminx.puremusic.data.bean.LibraryInfo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setInfo(@Nullable com.kunminx.puremusic.data.bean.LibraryInfo Info) {
        this.mInfo = Info;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.kunminx.puremusic.data.bean.LibraryInfo info = mInfo;
