...
import com.plkj.crazydemo.performanceOptimization.async.ThreadPoolUtils;
import com.plkj.crazydemo.performanceOptimization.bean.NewsItem;
import com.plkj.crazydemo.performanceOptimization.net.JobSchedulerService;
import com.plkj.crazydemo.performanceOptimization.net.RetrofitNewsUtils;
import com.plkj.crazydemo.performanceOptimization.utils.ExceptionMonitor;
...
//        new AsyncLayoutInflater(PerformanceOptimizationActivity.this)
//                .inflate(R.layout.activity_performance_optimization, null, new AsyncLayoutInflater.OnInflateFinishedListener() {
//            @Override
//            public void onInflateFinished(@NonNull View view, int i, @Nullable ViewGroup viewGroup) {
//                setContentView(view);
//                mRecyclerView = findViewById(R.id.recycler_view);
//                mRecyclerView.setLayoutManager(new LinearLayoutManager(PerformanceOptimizationActivity.this));
//                mRecyclerView.setAdapter(mNewsAdapter);
//                mNewsAdapter.setOnFeedShowCallBack(PerformanceOptimizationActivity.this);
//            }
//        });
...
//        X2C.setContentView(PerformanceOptimizationActivity.this, R.layout.activity_performance_optimization);
