...
public final class Message_Table extends ModelAdapter<Message> {
  ...
  public final String getCreationQuery() {
    return "CREATE TABLE IF NOT EXISTS `Message`(`id` TEXT, `content` TEXT, `attach` TEXT, `type` INTEGER, `createAt` TEXT, `status` INTEGER, `group_id` TEXT, `sender_id` TEXT, `receiver_id` TEXT, PRIMARY KEY(`id`)"+ ", FOREIGN KEY(`group_id`) REFERENCES " + com.raizlabs.android.dbflow.config.FlowManager.getTableName(net.qiujuer.italker.factory.model.db.Group.class) + "(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION"+ ", FOREIGN KEY(`sender_id`) REFERENCES " + com.raizlabs.android.dbflow.config.FlowManager.getTableName(net.qiujuer.italker.factory.model.db.User.class) + "(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION"+ ", FOREIGN KEY(`receiver_id`) REFERENCES " + com.raizlabs.android.dbflow.config.FlowManager.getTableName(net.qiujuer.italker.factory.model.db.User.class) + "(`id`) ON UPDATE NO ACTION ON DELETE NO ACTION" + ");";
  }
  ...
  public final void loadFromCursor(FlowCursor cursor, Message model) {
    ...
    if (index_group_id_Group_Table != -1 && !cursor.isNull(index_group_id_Group_Table)) {
      model.setGroup(new net.qiujuer.italker.factory.model.db.Group());
    ...
    if (index_sender_id_User_Table != -1 && !cursor.isNull(index_sender_id_User_Table)) {
      model.setSender(new net.qiujuer.italker.factory.model.db.User());
    ...
    if (index_receiver_id_User_Table != -1 && !cursor.isNull(index_receiver_id_User_Table)) {
      model.setReceiver(new net.qiujuer.italker.factory.model.db.User());
